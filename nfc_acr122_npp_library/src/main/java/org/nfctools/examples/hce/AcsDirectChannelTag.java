...
public class AcsDirectChannelTag extends Tag implements ApduTag {
    ...
    public Response transmit(Command command){
        ...
        //Util.debugAPDUs(commandAPDU.getBytes(), null);
        try{
            ResponseAPDU res = card.getBasicChannel().transmit(commandAPDU);
            return new Response(res.getSW1(), res.getSW2(), res.getData());
        }
	...
	//@Override
	public Response transmit2(Command command) {

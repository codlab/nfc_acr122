...
public class AcsDirectChannelTag extends Tag implements ApduTag {
	...
	public Response transmit(Command command) {
		try {
            ...
            System.out.println("command : " + NfcUtils.convertBinToASCII(commandAPDU.getBytes()));
			...
			System.out.println("response : " + NfcUtils.convertBinToASCII(responseAPDU.getBytes()));
